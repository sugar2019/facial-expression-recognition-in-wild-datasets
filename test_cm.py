...
parser.add_argument('--model', default='PRE/model_RAF_pre_Wexpsm1(没有求log的wsm损失)/epoch23_acc0.8510.pth',help='the path of trained model')
parser.add_argument('--test_result_path',default='PRE/model_RAF_pre_Wexpsm1(没有求log的wsm损失)/test_result',help='path of test result')
parser.add_argument('--csv_name',default='RAF_pre_Wexpsm1.csv',help='name of csv')
parser.add_argument('--save_img_name',default='RAF_pre_Wexpsm1.jpg',help='name of save img')
