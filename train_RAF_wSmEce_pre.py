...
def parse_args():
    ...
    parser.add_argument('--checkpoint', type=str, default='model_RAF_pre_wSmEce2', help='Pytorch checkpoint file path')
    parser.add_argument('--pretrained', type=str, default=True, help='Pretrained weights.')

    parser.add_argument('--gamma', type=float, default=1., help='weight of center loss.')
    parser.add_argument('--lambda1', type=float, default=1., help='weight of inter_class loss included in island loss .')
...
def weighted_ECE_loss(features, centers, targets, weight, lambda1):
    n = features.size(0)
...
def run_training():
    ...
    for i in range(1, args.epochs + 1):
        ...
        for imgs, targets, indexes in tqdm(train_loader):
            ...
            center_loss = weighted_ECE_loss(features, selfCenters, targets, weight, args.lambda1)
