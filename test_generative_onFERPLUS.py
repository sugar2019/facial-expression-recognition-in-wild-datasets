...
parser.add_argument('--model', default='../PRE/i_model_RAF_pre_Wsm1(正常的wsm损失)/epoch30_acc0.8543.pth',help='the path of trained model')
parser.add_argument('--test_result_path',default='../RAF_FERPLUS_general_result/wSm1',help='path of test result')
parser.add_argument('--csv_name',default='wSm1.csv',help='name of csv')
parser.add_argument('--save_img_name',default='wSm1.jpg',help='name of save img')
